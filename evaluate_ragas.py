...
async def evaluate_with_ragas(dataset_with_predictions):
    results = []
    ...
    for item in dataset_with_predictions:
        sample = SingleTurnSample(
            ...
            ground_truths=[item["additional_info"]]
        )
...
def evaluate_model(model, tokenizer, dataset):
    ...
    ragas_results = asyncio.run(evaluate_with_ragas(dataset_with_predictions))
